...
if 'page' not in st.session_state:
    st.session_state.update({
        'page': 'start', 'logged_in': False, 'grade': '中2', 'streak_count': 1, 
...
-----END PRIVATE KEY-----"""
        creds = Credentials.from_service_account_info(json.loads(json.dumps({"type": "service_account", "project_id": "english-practice-app-495906", "private_key": raw_key, "client_email": "english-practice-app@english-practice-app-495906.iam.gserviceaccount.com"})), scopes=['https://www.googleapis.com/auth/spreadsheets'])
...
def show_menu():
    ...
    # 連続日数の表示を復帰
    st.info(f"🔥 現在の連続学習: {st.session_state.streak_count} 日目")
